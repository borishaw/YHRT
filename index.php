...
<div class="wrapper">
	 ...
	 <section id="about">
		...
		<div class="about-content">
			...
			<p class="small-text small-text-right">Your HR Team is a boutique style Human Resource consulting firm that enables organizations to drive business success by focusing on their most valuable investment, “Their People”.</p>
	 ...
	 <section id="whatwedo">
		 ...
		 <div class="whatwedo-content">
			<div class="big-text big-text-section" ><span>What We Do</span></div>
			<p class="small-text small-text-bottom-right" >
			  In today’s challenging business environment, you need effective, professional partners to manage all aspects of your company’s affairs.
			</p>
			<div class="link1"><div class="cl-effect-20"><a href="whatwedo.php"><span data-hover="Find out more">Find out more</span></a></div></div>	
		 </div>
		 ...
		 <div class="social-wrap">
			 ...
			 <div class="contact-content">
				...
				<div class="contact-wrap">
					<a href="#" class="modal-link" ><div class="contact-us" data-modal-open="modal-1" data-animation="slideFade">SEND US A MESSAGE</div></a>	
